...
\todo[inline]{Going to change the description above and below this figure since
  its changed.}
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering,margin=2cm}
    \begin{subfigure}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{img/array-hist-init.png}
      
\caption{Initial Conditions: \\ mean and standard deviation  of agents' opinions.}
    \end{subfigure}
    
     \begin{subfigure}[b]{0.49\textwidth}
       \includegraphics[width=\textwidth]{img/end-mean.png}
       \caption{Final state: \\ agents' mean opinions.}
     \end{subfigure}
          \begin{subfigure}[b]{0.49\textwidth}
       \includegraphics[width=\textwidth]{img/end-std.png}
       \caption{Final state: \\ standard deviations of opinions}
     \end{subfigure}
     \caption{Initial and final states for 60.000 parameterizations. \(N = 500\)
     for comparability.} 
     \label{fig:std}
    \end{figure}
