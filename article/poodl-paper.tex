...
\caption{Initial Conditions.}
 ...
 \caption{\(p^*\) Case.}
  ...
  \caption{\(p^{**}\) Case.}
    ...
    \cite{saltelli2000sensitivity}. %%%%%%% EXPLAIN what is the index. Make it short, but you must say what is calculated (a simple equation might do it) and what it means (larger index values mean more influence)
